...
To explore the influence of different numbers of Graph Convs and Transformer Layers ($n$ and $m$, respectively) in each TextGT block, we further perform configuration studies on Restaurant and Twitter, and the results are as follows. <br/><br/><img src="resources/number_study_restaurant.png" style="width:30%; padding-left:5%"/><img src="resources/number_study_twitter.png" style="width:30%; padding-left:5%"/> 
